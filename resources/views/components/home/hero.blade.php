    ...
    <div class="flex flex-wrap -mx-4">
      <div class="w-full lg:w-5/12 px-4">
        <div class="hero-content">
          ...
          >
            My Name is Peter Mwita. <br/>
            I am <span class="rounded-md text-amber-600">A Web Designer & Developer</span>.
          </h1>
          <p class="text-base mb-8 max-w-[520px]">
            I am a Designer and Developer, a life long learner, and ready for new opportunities. I create bespoke websites that help businesses get more customers and look better online. <br/>
            Abit about me, I love music, arts and gaming.My favourite Movie series so far is Game of thrones.
        <!--     <a
